...
// Move save data mode (see https://gist.github.com/Suyooo/84baa6a8a5fb57f2e05c02d0698985c4)
if (window.location.hash === "#export-save") {
    ...
    const movingSaveData = prompt("Please paste your save data here to load it.\n\n" +
        "WARNING: Any save data you have on this page will be overwritten! (Click Cancel if you don't want that)");
    if (movingSaveData) {
        let saveDataParsed;
        try {
